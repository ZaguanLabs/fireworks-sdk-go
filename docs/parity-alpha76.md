...
The final alpha.76 sweep compared both `docs/fireworks-py/python-sdk-1.2.0-alpha.76/src` and `docs/fireworks-py/python-sdk-1.2.0-alpha.76/dist/fireworks_ai-1.2.0a76/src`, plus their `tests` trees. The source and built trees are byte-for-byte equivalent for the SDK and tests, the generated resource/type parity report has no missing Go resources or expected type names, and the training SDK `__all__` export surface maps to Go exports or documented Go-native replacements.
