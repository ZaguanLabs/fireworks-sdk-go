# Fireworks SDK Go resource/type parity report (1.2.0-alpha.82)

Python SDK source: `docs/fireworks-py/python-sdk-1.2.0-alpha.82/src/fireworks`.
...
- Python classes, exported aliases, and top-level type exports expected: 346
- Go generated/alias type names: 378
