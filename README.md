...
This project targets Fireworks Python SDK `1.2.9` and keeps the Go
package version aligned exactly:

```go
fireworks.Version // "1.2.9"
```
...
[`docs/resource-type-parity-1.2.9.md`](docs/resource-type-parity-1.2.9.md).
The broader training parity matrix is in
[`docs/parity-1.2.9.md`](docs/parity-1.2.9.md).
...
```sh
FIREWORKS_PY_TYPES_ROOT=/path/to/python-sdk-1.2.9/src/fireworks/types \
  go generate ./types
```
...
```text
docs/fireworks-py/python-sdk-1.2.9/src/fireworks/types
```
