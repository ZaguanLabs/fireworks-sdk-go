...
This project targets Fireworks Python SDK `1.2.0-alpha.76` and keeps the Go
package version aligned exactly:

```go
fireworks.Version // "1.2.0-alpha.76"
```
...
[`docs/resource-type-parity-alpha76.md`](docs/resource-type-parity-alpha76.md).
The broader training parity matrix is in
[`docs/parity-alpha76.md`](docs/parity-alpha76.md).
...
```sh
FIREWORKS_PY_TYPES_ROOT=/path/to/python-sdk-1.2.0-alpha.76/src/fireworks/types \
  go generate ./types
```
